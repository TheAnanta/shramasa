            ...
            <div className="flex gap-8 my-8 items-start w-full">
                ...
                <div className="w-full">
                    <div className="flex flex-row gap-8 grow">
                        ...
                        <div className="w-56">
                            <p><b>Payment ID: </b>{response.paymentId}</p>
                            <p><b>Delivery ID: </b>{response.deliveryDate || 'N/A'}</p>
                            <p><b>Amount: </b>Rs. {(response.payment)?.amount ?? 'Amount'}</p>
                            <p><b>Status: </b>{(response.payment)?.status ?? 'Status'}</p>
                            <p><b>Method: </b>{(response.payment)?.method ?? 'Method'}</p>
                            <p><b>Payment Details: </b>{response.payment?.paymentDetails}</p>
                        </div>
                    </div>
                </div>
            </div>
